    ...
    <div className='fixed top-0 bg-white w-full z-40 '>
            ...
            {!current_user ? (
              <>
                ...
                >
                  ...
                  <p className='capitalize text-xs font-semibold'>Connect wallet</p>
                </NavLink>
              </>
            ) : (
              <>
      ...
      <header className='px-5 lg:px-7 py-4 flex justify-between items-center border-b-[1px]'>
        ...
        <section className='3 items-center hidden lg:flex gap-3'>
          <Link to='/'>
            <img className='h-9 w-9' src='/favicon/logo.png' alt='blog' />
          </Link>
        ...
        <section className='flex gap-5 items-center'>
          ...
          {!current_user ? (
            <Link to='/auth/login'>
              <button className='px-4 py-2 rounded-full bg-orange-500 text-white'>Connect wallet</button>
            </Link>
          ) : (
            <>
