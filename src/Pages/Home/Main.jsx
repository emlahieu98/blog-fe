...
export default function Main() {
    return (
        <>
            <section class="min-h-screen bg-white py-6 flex flex-col justify-center items-center">
                <div class="w-full max-w-xl border border-gray-300 rounded-2xl py-3 px-5">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <div class="text-gray-500 leading-4">@emlahieu</div>
                        </div>
                    ...
                    <div class="py-3">
                        <p class="text-lg">
                            Ra xã hội làm ăn bươn chải, liều thì ăn nhiều, không
                            liều thì ăn ít. Muốn thành công thì phải chấp nhận
                            trải qua đắng cay ngọt bùi. Làm ăn muốn kiếm được
                            tiền thì phải chấp nhận mạo hiểm, nguy hiểm một tí
                            nhưng trong tầm kiểm soát. Xã hội này, chỉ có làm,
                            chịu khó cần cù thì bù siêng năng. Chỉ có làm thì
                            mới có ăn. Thế cho nó dễ!
                        </p>
                        <div class="flex">
            ...
            <section class="flex sm:flex-row flex-col space-y-2 sm:space-x-2 flex-row w-full items-center justify-center min-h-screen">
