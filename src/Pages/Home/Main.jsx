                        ...
                        <div key={index}>
                            ...
                            >
                                <div className="text-white mx-4 md:ml-7 w-[640px]">
                                    <h1 className="capitalize font-bold text-2xl md:text-3xl mb-3">
                                        {item.title}
                                    </h1>
            ...
            <section>
                <div className="bg-white py-6 flex flex-col justify-center items-center ">
                    <div
                        ...
                        style={{
                            backgroundImage: `linear-gradient(to right, rgb(254,33,94), rgb(255,148,2))`,
                        }}
                    >
                                ...
                                <div class="w-full max-w-xl border border-gray-300 rounded-2xl py-3 px-5">
                                    ...
                                    <div class="flex space-x-5 pt-3 text-gray-500 border-t border-gray-300">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <span> Copy link to twitter </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
