        ...
        <>
            <main className="pl-8">
                <section className="max-w-[840px] mb-7 md:mb-14 text-sm md:text-base font-medium md:font-normal">
                    <h1 className="text-xl md:text-2xl font-extrabold capitalize mb-4">
                        Savvy Fitness
                    </h1>
                    <p className="text-justify mb-3">
                        Savvy Fitness là một sản phẩm kết hợp giữa AI và
                        Blockchain giúp mọi người có thể tập các bài tập tại nhà
                        miễn phí và nâng cao sức khỏe
                    </p>
                    {/* <p className=" text-justify mb-3">
                        Tại Việt Nam,{' '}
                    ...
                    <p className="text-justify mb-3">
                        ...
                        theo đuổi sự nghiệp trở thành một lập trình viên
                        Back-end.
                    </p>
                    <blockquote className='relative text-justify before:w-1 px-3 before:h-full ml-4 before:absolute before:top-0 before:left-0 before:bg-orange-400 before:content-[""]'>
                        <p>
                            Các khóa học có thể chưa đầy đủ, F8 vẫn đang nỗ lực
                ...
                {/* <section className="max-w-[1140px] text-sm font-medium md:font-normal md:text-base">
                    ...
                    <p className="text-sm text-justify font-medium mb-4">
                        Để theo ngành IT - Phần mềm cần rèn luyện những kỹ năng
                        nào? Bạn đã có sẵn tố chất phù hợp với ngành chưa? Cùng
                        thăm quan các công ty IT và tìm hiểu về văn hóa, tác
                        phong làm việc của ngành này nhé các bạn.
                    </p>
                    <div className="border-2 p-3 sm:p-4 rounded-xl sm:flex gap-5 items-start mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium md:text-base md:font-normal py-3">
                                Trong khóa này chúng ta sẽ cùng nhau xây dựng
                                giao diện 2 trang web là The Band & Shopee.
                            </p>
                            <button className="w-full sm:w-auto text-center text-white bg-orange-500 py-2 px-5 rounded-full font-medium">
                                Xem khóa học
                            </button>
                        </div>
                    </div>
