    ...
    <main className='lg:px-8'>
      ...
      <section className='flex gap-8 justify-between flex-wrap lg:flex-nowrap'>
        ...
        <div className='w-full order-1 lg:order-2  lg:w-4/12 lg:px-4'>
          <h3 className='text-gray-500 uppercase font-medium mb-5'>CÁC TAGS ĐƯỢC ĐỀ XUẤT</h3>
          <div className='flex gap-2 flex-wrap'>
            <p className='text-sm px-3 py-2 font-medium rounded-full bg-gray-200'>Nodejs / Express </p>
            <p className='text-sm px-3 py-2 font-medium rounded-full bg-gray-200'>Solidity</p>
            <p className='text-sm px-3 py-2 font-medium rounded-full bg-gray-200'>ReactJs / NextJs</p>
