  ...
  return (
    <main className='w-full h-screen flex flex-col justify-between gap-8 items-center py-5 px-6'>
      <div className='flex items-center gap-3 self-start'>
        <Link to='/'>
          <img className='h-12 w-12 object-contain' src='/favicon/logo.png' alt='' />
        </Link>
        <h3 className='text-md font-bold'>emlahieu</h3>
      </div>
      ...
      <p className='font-bold text-gray-500'>© 2022 All rights reserved.</p>
    </main>
  );
}
